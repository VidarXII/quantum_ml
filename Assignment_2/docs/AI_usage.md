...
Do a similar markdown file on how to replicate my work. Note that my training data is saved in the data folder within src, the various python files are in src,
my best training weights are saved as a.pt file in outputs/, docs contains the model_working file and this file.
Make sure to mention required packages (also I had to use python 3.11 specifically
because later versions of python aren't compatible with some of these packages yet)

I'll be pushing the code onto github as different python files, what all references should I change so that the code still makes sense
